<?php
/**
 * Homepage 9 - Product Category 4 Section
 *
 * @package ConBonus
 * @since 1.0.0
 */
            ...
            <div class="d-flex">
                <div class="box-category-left">
                    <div class="box-menu-category bg-white">
                        <h5 class="title-border-bottom mb-20"><?php _e('Sports & Fitness', 'conbonus'); ?></h5>
                        <ul class="list-nav-arrow">
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Exercise Equipment', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Fitness Accessories', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Sports Gear', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Outdoor Sports', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Team Sports', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Water Sports', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Winter Sports', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Sports Nutrition', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Athletic Wear', 'conbonus'); ?></a></li>
                        </ul>
                    </div>
                </div>
                <div class="box-category-right">
                    <div class="row">
                        ...
                        $product_images = array('sp27.png', 'sp28.png', 'sp29.png', 'sp30.png');
                        $labels = array('Hot', 'Deal', 'Hot');
                        
                        foreach ($products as $index => $product) :
                            $product_obj = wc_get_product($product->ID);
                            $image = isset($product_images[$index]) ? $product_images[$index] : 'sp27.png';
