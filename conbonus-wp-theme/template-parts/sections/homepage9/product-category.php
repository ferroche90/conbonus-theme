<?php
/**
 * Homepage 9 - Product Category Section
 *
 * @package ConBonus
 * @since 1.0.0
 */
            ...
            <div class="d-flex">
                <div class="box-category-left">
                    <div class="box-menu-category bg-white">
                        <h5 class="title-border-bottom mb-20"><?php _e('Computers Accessories', 'conbonus'); ?></h5>
                        <ul class="list-nav-arrow">
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Monitors & Projects', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Screen Protectors', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Computers & Tablets', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Data Storage', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Laptop Accessories', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Networking Products', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Tablet Accessories', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Camera Privacy Covers', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Chargers & Adapters', 'conbonus'); ?></a></li>
                        </ul>
                    </div>
                </div>
                <div class="box-category-right">
                    <div class="row">
                        ...
                        $product_images = array('imgsp7.png', 'imgsp3.png', 'imgsp6.png', 'imgsp5.png');
                        $labels = array('Hot', 'Deal', 'Hot');
                        
                        foreach ($products as $index => $product) :
                            $product_obj = wc_get_product($product->ID);
                            $image = isset($product_images[$index]) ? $product_images[$index] : 'imgsp7.png';
                                ...
                                <div class="card-grid-inner">
                                    ...
                                    <div class="image-box">
                                        ...
                                        <a href="<?php echo esc_url(get_permalink($product->ID)); ?>">
                                            <img src="<?php echo CONBONUS_THEME_URL; ?>/assets/imgs/page/homepage1/<?php echo esc_attr($image); ?>" alt="<?php echo esc_attr($product->post_title); ?>">
                                        </a>
                                    </div>
