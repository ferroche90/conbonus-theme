<?php
/**
 * Homepage 9 - Product Category 2 Section
 *
 * @package ConBonus
 * @since 1.0.0
 */
            ...
            <div class="d-flex">
                <div class="box-category-left">
                    <div class="box-menu-category bg-white">
                        <h5 class="title-border-bottom mb-20"><?php _e('Furniture & Decor', 'conbonus'); ?></h5>
                        <ul class="list-nav-arrow">
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Sofas & Couches', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Living Room Tables', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Living Room Furniture', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Dressers & Chests', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Beds, Frames & Bases', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Patio Conversation Sets', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Living Room Tables', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('Chaise Lounges', 'conbonus'); ?></a></li>
                            <li><a href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php _e('TV & Media Furniture', 'conbonus'); ?></a></li>
                        </ul>
                    </div>
                </div>
                <div class="box-category-right">
                    <div class="row">
                        ...
                        $product_images = array('sp19.png', 'sp20.png', 'sp21.png', 'sp22.png');
                        $labels = array('Hot', 'Deal', 'Hot');
                        
                        foreach ($products as $index => $product) :
                            $product_obj = wc_get_product($product->ID);
                            $image = isset($product_images[$index]) ? $product_images[$index] : 'sp19.png';
